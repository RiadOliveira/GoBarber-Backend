...
let ListProviderMonthAvailabilityService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    const availability = eachDayArray.map(day => {
      ...
      const appointmentsInDay = findedAppointments.filter(appointment => (0, _dateFns.getDate)(appointment.date) === day);
      return {
        day,
        available: appointmentsInDay.length < 10 && (0, _dateFns.isAfter)(compareDate, new Date())
      };
    });
    return availability;
  }
